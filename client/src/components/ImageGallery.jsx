...
const ImageGallery = (props) => (
    ...
    <div onMouseOver={()=>props.onAddArrows()} onMouseOut={()=>props.onRemoveArrows()}>
        ...
        {props.arrows && !props.modalIsOpen && <span className={styles.left}><i className="fas fa-chevron-left" onClick={(e)=>props.onBackScroll(e)}></i></span>}
        ...
        {/* This code code prevents the gallery from repositioning with the arrows */}
        {props.arrows && !props.modalIsOpen && <span className={styles.right}><i className="fas fa-chevron-right" onClick={(e)=>props.onClickScroll(e)}></i></span>}
